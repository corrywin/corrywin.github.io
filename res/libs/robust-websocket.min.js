! function(e, t) {
    ...
    var n = function(o, i, r) {
        var c, s, u = {
            ...
            p = !1,
            d = !1,
            m = Object.assign({}, n.defaultOptions, "function" == typeof r ? {
                shouldReconnect: r
            } : r);
        ...
        function E() {
            b && (e.removeEventListener("online", h), e.removeEventListener("offline", v), b = !1)
        }

        function g(e) {
            if (!m.shouldReconnect.handle1000 && 1e3 === e.code || d) a = 0;
            else if (!1 !== t.onLine) {
                var n = m.shouldReconnect(e, f);
                "number" == typeof n && (s = setTimeout(O, n))
            } else p = !0
        }

        function O() {
            s = null, (u = new WebSocket(o, i || void 0)).binaryType = f.binaryType, a++, f.dispatchEvent(Object.assign(new CustomEvent("connecting"), {
                attempts: a,
                reconnects: l
            })), c = setTimeout(function() {
                c = null, E(), f.dispatchEvent(Object.assign(new CustomEvent("timeout"), {
                    attempts: a,
                    reconnects: l
                }))
            }, m.timeout), ["open", "close", "message", "error"].forEach(function(e) {
                u.addEventListener(e, function(t) {
                    f.dispatchEvent(t);
                    var n = f["on" + e];
                    if ("function" == typeof n) return n.apply(f, arguments)
                })
            }), m.ignoreConnectivityEvents || b || (e.addEventListener("online", h), e.addEventListener("offline", v), b = !0)
        }
        f.send = function() {
            return u.send.apply(u, arguments)
        }, f.close = function(e, t) {
            return "number" != typeof e && (t = e, e = 1e3), y(), p = !1, d = !0, E(), u.close(e, t)
        }, f.open = function() {
            u.readyState !== WebSocket.OPEN && u.readyState !== WebSocket.CONNECTING && (y(), p = !1, d = !1, O())
        }, Object.defineProperty(f, "listeners", {
            value: {
                open: [function(e) {
                    c && (clearTimeout(c), c = null), e.reconnects = ++l, e.attempts = a, a = 0, p = !1
                }],
                close: [g]
            }
    ...
    return n.defaultOptions = {
        ...
        automaticOpen: !0
    }, n.prototype.binaryType = "arraybuffer", n.prototype.addEventListener = function(e, t) {
        ...
        if (e.type in this.listeners)
            for (var t = this.listeners[e.type], n = 0, o = t.length; n < o; n++) t[n].call(this, e)
    }, n
